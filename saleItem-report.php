                  ...
                  <div class="box span12">
                     <div class="box-header" data-original-title>
                        <h2>
                            ...
                            <a href="saleInvoice.php"><?=SALES?></a> >> <?=ITEMS_REPORT?>
                        </h2>
                        <div class="box-icon">
                           ...
                           <fieldset>
                               <div class="control-group">
                                   <div class="salesOptions">
                                       ...
                                       <div class="controls">
                                           <select onchange="this.form.submit()"  data-rel="chosen" name="catid">
                                               <option value="">&nbsp;</option>
                                                <?php
                               ...
                               <div class="control-group">
                                   <div class="salesOptions">
                                       ...
                                       <div class="controls">
                                           <select data-rel="chosen"  name="data-erntry">
                                               <option value="">&nbsp;</option>
                                                <?php
                                   ...
                                   <div class="salesOptions">
                                       ...
                                       <div class="controls">
                                           <select  data-rel="chosen" name="sales-man">
                                               <option value="">&nbsp;</option>
                                        <?php
          ...
          <?php
            if(isset($_POST['Submit']))
            {
                ...
                $reSalesTotal   =0;
                 ...
                 if ($iid) 
                 {
                     $conditionItem .=" AND i.item_thread = '$iid'";    
                     $query         = "SELECT * FROM items WHERE item_thread='$iid' AND storeid='$storeid'";
                     $resCust      = mysqli_query($adController->MySQL,$query);
                     $dataCust     = mysqli_fetch_assoc($resCust);
                 ...
                 if ($cust)
                 {
                     $conditionRep .=" AND customer = '$cust'";
                ...
                <div>
                    ...
                    <div class="box span12">
                        <a href='reports/saleItemReport.php' target='_blank'>
...
//                               echo $dataAll[id].'---- <br>';
                               ...
                               $queryItem            = "SELECT si.*, s.* FROM sales_items si, sales s WHERE si.itemid = '$itemid' AND si.invoice_No = s.invoicenumber AND si.state ='1' $conditionRep" ;
//                               echo '--- '.$queryItem.'<br>';
...
//                               echo $dataAll[id].'---- <br>';
                               ...
                               $name = $dataAll['name'].' '.$dataAll['unit'];
//                               echo $name.'---- <br>';  
                               
                               $queryItem            = "SELECT si.*, s.* FROM sales_ret_items si, sales_ret s WHERE si.itemid = '$dataAll[id]' AND si.invoice_No = s.invoicenumber AND si.state ='1' $conditionRep" ;
//                               echo '--- '.$queryItem.'<br>';
...
//                                     $vatTotal      += $vatItem;
            ...
            $query   = "INSERT INTO `report_saleitem_all`"
                    ...
                    . "('$fdate','$tdate','$branchName', '$custName','$catName','$itemName','$allGross',  '$allDdisc', '$allVat',  '$allSales',  '$allReSales',  '$net' )";
                 mysqli_query($adController->MySQL,$query) or die(mysqli_error($adController->MySQL).'alllll');                    
             ?>            
            </div>
         </div>
