			...
			<div>  <!--class="row-fluid sortable"-->
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span><?=PURCHASES?></h2>
					</div>
					<div class="box-content">
						<p align="right">
							<a class="btn btn-success" href="add_purchase.php">
								<i class="icon-plus"></i>
							</a>
						</p>
						  	...
						  	<tbody>
								<?php
									...
									$query	 	= "SELECT * FROM purchase WHERE storeid='$storeid' AND state = '1' ORDER BY invoicenumber DESC";
									...
									while($data 	= mysqli_fetch_assoc($res))
									{
										...
										$invoiceTable	= urlencode($adController->encrypt_decrypt(1,'purchase',0));
...
//											echo "<td>$dated</td>";
                                                                                        echo "<td class='center'>
                                                                                                                <a href='reports/purchase.php?sd=$invoice' target='_blank'>
                                                                                                                        <img src='img/print.png' style='width:30px'>
                                                                                                                </a>  </td>";                                                                                           
											echo "<td class='center'>
													<a class='btn btn-info' href='edit_purchase.php?sd=$idval'>
