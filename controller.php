...
//    mysqli_query($this->MySQL,$sSQL) ;	    
	...
	function emailPresentEmp($email,$identifier,$id)
	{
		...
		if($identifier == 1)
			...
			$query 		= "SELECT * FROM employees WHERE email = '$email'  AND id!='$id'";
        ...
        function userPresent()
        {
            ...
            $sql_check = mysqli_query($this->MySQL,"SELECT id FROM employees WHERE user='$username'") or die(mysqli_error($this->MySQL));
