			...
			<div>
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span><?=ADD_OUTGOING_INVOICE?></h2>
					</div>
					<div class="box-content">
						<form class="form-horizontal" id="outgoing-form">
						  <input type="hidden" value="addUotgoing" name="f">
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
								...
								<div class="controls">
								  <input type="text" class="datepicker-nobar" name="date" value='<?php echo date("d/m/Y")?>'>
								</div>
							</div>
                                                        </div>
                                                      <br>
