...
$query          = "SELECT * FROM outgo WHERE id='$id'";
$resP           = mysqli_query($adController->MySQL,$query);
$dataPur        = mysqli_fetch_assoc($resP);

$query		= "SELECT * FROM outgo_items WHERE storeid='$storeid' AND outgo_No='$dataPur[outgo_No]'";
			...
			<div>
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span><?=EDIT_OUTGOING_INVOICE?></h2>
					</div>
					<div class="box-content">
						<form class="form-horizontal" id="outgoing-form">
                                                    <input type="hidden" value="<?=$id?>" name='sd'>
						  <input type="hidden" value="editOutgoing" name="f">
						  <fieldset>
...
<!--							<div class="control-group">
							  ...
							  <div class="controls">
								  <select name="branch" data-rel="chosen">
                                    ...
                                    <div class="control-group" >
                                        <label class="control-label"><?=OUTGOING_ITEMS?></label>
...
<!--                                    <div class="control-group">
							...
							<div class="form-actions">
							  <button type="button" id='submit-outgo' class="btn btn-primary"><?=SAVE?></button>
