...
<head>
	...
	<title>WAM Tech POS - <?= ADD_NEW ?> <?= CUSTOMER ?></title>
			...
			<main class="admin-content">
				...
				<div class="card-pro">
					<div class="card-header-pro">
						<h2 class="card-title-pro"><i class="fas fa-info-circle"></i> معلومات العميل</h2>
					</div>
						...
						<form id="add-customer">
							...
							<div class="mb-4">
								...
								<div class="form-group-pro">
									<label class="form-label-pro"><?= CUSTOMER_NAME ?></label>
							...
							<div class="d-flex gap-2 mt-4">
								<button type="button" id='submit-customer' class="btn-pro btn-pro-success">
									<i class="fas fa-save me-1"></i><?= SAVE ?>
								</button>
								<button type="reset" class="btn-pro btn-pro-outline">
									<i class="fas fa-times me-1"></i><?= CANCEL ?>
								</button>
								<a href="customers.php" class="btn-pro btn-pro-outline ms-auto">
