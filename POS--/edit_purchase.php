...
$invoice             = $_REQUEST['sd'];
$query          = "SELECT * FROM purchase WHERE invoicenumber='$invoice'";
$resP           = mysqli_query($adController->MySQL,$query);
$dataPur        = mysqli_fetch_assoc($resP);

$query		= "SELECT * FROM purchase_items WHERE storeid='$storeid' AND invoice_No='$invoice'";
			...
			<div>
				<div class="box span12">
					<div class="box-header" data-original-title>
                                            <h2><i class="halflings-icon edit"></i><span class="break"></span><a href="purchase.php"><?=PURCHASES?></a> >> <?=EDIT?></h2>
					</div>
					<div class="box-content">
						<form class="form-horizontal" id="purchase-form">
						  <input type="hidden" value="editPurchase" name="f">
						  <fieldset>
                                        ...
                                        <div class="salesOptions">
                                            ...
                                            <div class="controls">
                                                ...
                                                <input type="radio" name="payType" value="1" <?=$dataPur['paymentType']=="1" ? "checked" : "" ?>><?=CASH?>
                                                 ...
                                                 <label>
                                                <input type="radio" name="payType" value="4" <?=$dataPur['paymentType']=="4" ? "checked" : "" ?>><?=LEFT?>
                                                 </label>
                                            </div>
                                        </div>                                                               
							</div>                                                      
