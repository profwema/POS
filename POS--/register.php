...
//  when submit get's posted which happens when the button is clicked.
 if(isset($_POST["open_clicked"]))
		{
	try {
				
			$connector = new FilePrintConnector("//localhost/XP-80C");
	...
	<?php echo form_open($controller_name."/change_mode", array('id'=>'mode_form', 'class'=>'form-horizontal panel panel-default')); ?>
		<div class="panel-body form-group">
			<ul>
				...
				<!-- Start of Mike42 ESC/POS  Create Open Drawer Button -->

				<li class="pull-right">
					<button class='btn btn-default btn-sm'  input type="submit" name="open_clicked" href="<?php open_drawer(); ?>">
					  	<span class="glyphicon glyphicon-align-justify">&nbsp</span><?php echo 'Open Drawer'; ?>
					</button>
				</li>

				<!-- End of Mike42 ESC/POS  Create Open Drawer Button -->
...
$(document).ready(function()
{
	...
	$("#show_open_button").click(function()
	{
		$('#buttons_form').attr('action', "<?php echo site_url($controller_name."/open_drawer"); ?>");
		$('#buttons_form').submit();
	});
