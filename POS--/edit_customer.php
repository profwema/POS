...
$query		= "SELECT * FROM customers WHERE storeid='$storeid' AND id='$idval'";
			...
			<div>
				<div class="box span12">
					...
					<div class="box-content">                                                                                        
						<form class="form-horizontal" id="add-customer">
                                                <input type="hidden" value="<?=$idval2?>" name="nd" id="nd">
						  <input type="hidden" value="updateCustomer" name="f">
                                                  <fieldset>
							<h4><?=LANGUAGE_1?></h4>
							...
							<div class="form-actions">
							  <button type="button" id='submit-customer' class="btn btn-primary"><?=SAVE?></button>
