			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span><?=UNITS?></h2>
					</div>
					<div class="box-content">
						<form class="form-horizontal" id="update-units">
...
<!--                                                                    <label class="control-label" for="typeahead">< ?=SHIFT?> : </label>-->
							...
							<div class="form-actions">
							  <button type="button" id='submit-units' class="btn btn-primary"><?=SAVE?></button>
