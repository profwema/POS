				...
				<div class="box span12">
					<div class="box-header" data-original-title>
                                            <h2><i class="halflings-icon edit"></i><span class="break"></span>
                                                <a href="categories.php"><?=CATEGORIES?></a> >> <?=EDIT?>
                                            </h2>		
                                        </div>
							...
							<div class="control-group">
								...
								<div class="controls">
								  <label class="checkbox inline">
									<input type="checkbox" id="inlineCheckbox1" value="1" name="show_to_cashier" <?=$show_to_cashier?>>
								  </label>
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
								   <label class="checkbox inline">
									<input type="checkbox" id="inlineCheckbox1" value="1" name="enabled" <?=$enabled?>>
								  </label>
								</div>
							</div>
