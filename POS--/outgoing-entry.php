			...
			<div>  <!--class="row-fluid sortable"-->
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span><?=OUTGOING_ENTRY?></h2>
					</div>
					<div class="box-content">
						<p align="right">
                                                    <a class="btn btn-success" href="add_outgo.php">
								<i class="icon-plus"></i>
							</a>
						</p>
...
<!--                                                              <th><?=CREATED_ON?></th>-->
						  	...
						  	<tbody>
								<?php
									...
									$query	 	= "SELECT * FROM outgo WHERE storeid='$storeid' AND state = '1' ORDER BY `date` DESC";
...
//										$supplier	= $dataSup['name_'.$language];
										...
										$invoiceTable	= urlencode($adController->encrypt_decrypt(1,'outgo',0));
                                                                                $detailTable	= urlencode($adController->encrypt_decrypt(1,'outgo_items',0));
...
//											echo "<td>$dated</td>";
											...
											echo "<td class='center'>
													<a class='btn btn-info' href='edit_outgo.php?sd=$secondIdval'>
