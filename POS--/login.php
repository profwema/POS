...
<body>
  <div class="login-wrap" role="form" aria-label="Login Form">
    <h2><?= LOGIN ?></h2>
    <form id='form' class="form" method="POST" action="#">
      <?php echo csrf_input(); ?>
      <input type="text" placeholder="<?= USERNAME ?>" name="user" id="user" aria-label="<?= USERNAME ?>" required data-required-msg="<?= REQUIRED ?>" />
      <input type="password" placeholder="<?= PASSWORD ?>" name="password" id="password" aria-label="<?= PASSWORD ?>" required data-required-msg="<?= REQUIRED ?>" />


      <button type="button" id="login" accesskey="l" tabindex="0"><?= LOGIN ?> </button>
      <span>
