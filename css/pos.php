...
<body>
    ...
    <div class='delivery-table-content' id="customer_inf"> 
        ...
        <form class="pos-popup" id="add-customer" autocomplete="off">
            ...
            <div class ="buttons" >
                <button type="button"  id='submit-customer' src='1' class="btn btn-primary"><?=SAVE?></button>
    ...
    <div class='delivery-table-content' id="deliver_inf">
	    ...
	    <div class ="buttons" >
                ...
                <button type="button"  src='1' class="btn btn-primary submit-sale" onclick="closeTables()"><?=SAVE?></button>
            </div>
    </div>     
<!--    -->
