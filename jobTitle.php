...
<head>
	...
	<title>WAM Tech POS - <?= JOPTITLE ?></title>
			...
			<main class="admin-content">
				...
				<div class="page-header">
					...
					<div class="page-breadcrumb">
						...
						<span class="breadcrumb-separator">/</span>
						<div class="breadcrumb-item">
							<span class="text-primary"><?= JOPTITLE ?></span>
						</div>
					</div>
				</div>
				...
				<div class="card-pro">
					<div class="card-header-pro">
						<h2 class="card-title-pro">
							...
							تحديث المسميات الوظيفية
						</h2>
					</div>
					<div class="card-body-pro">
						<form id="update-jobTitle">
							...
							<div class="d-flex gap-2 mt-4">
								<button type="button" id='submit-jobTitle' class="btn-pro btn-pro-primary">
